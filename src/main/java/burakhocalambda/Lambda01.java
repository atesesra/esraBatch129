...
public class Lambda01 {
    ...
    public static void ciftVePozitifMetRef(List<Integer> sayi){
        ...
        sayi.stream().filter(t->t%2==0 && t>0).forEach(burakhocalambda.Utils::yazdir);
    ...
    public static void kareYazdir(List<Integer> sayi){
        ...
        sayi.stream().map(burakhocalambda.Utils::kareBul).forEach(burakhocalambda.Utils::yazdir);
    ...
    public static void kareTekrarsiz(List<Integer> sayi){
        ...
        sayi.stream().map(burakhocalambda.Utils::kareBul).distinct().forEach(burakhocalambda.Utils::yazdir);
    ...
    public static void buyKucSirala(List<Integer> sayi){
        ...
        sayi.stream().sorted(Comparator.reverseOrder()).forEach(burakhocalambda.Utils::yazdir);
