...
*/
    ...
    //protected olanlar baska packagedan sadece child classlarda gorulur.
    protected String address="Istanbul";

    //default olanlar baska packagedan kullanilamazlar is yeri maili
    String email="ebcan@gmail.com";

    //private olanlar sadece olusturulduklari class icinde kullanilabilirler TC No
