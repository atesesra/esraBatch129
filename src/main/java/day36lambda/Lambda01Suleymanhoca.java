...
public class Lambda01Suleymanhoca {
    ...
    public static void printAllSortWithLastCharUpperDistinct2(List<String>list){
        list.
                ...
                sorted(Comparator.comparing(UtilsSuleymanhoca::getLastChar).
                        reversed()).
                forEach(UtilsSuleymanhoca::printInTheSameLineWithSpace);
    }
    ...
    public static List<Integer>printLengthSquare(List<String>list){
        return list.stream().map(UtilsSuleymanhoca::getLengthSquare).collect(Collectors.toList());
    }
    ...
    public static List<String>printElementsLengthEven(List<String>list){
        return list.stream().filter(UtilsSuleymanhoca::isEven).collect(Collectors.toList());
    }
}
