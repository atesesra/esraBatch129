...
public class Arrays04 {
    public static void main(String[] args) {
        ...
        //Ex2:String bir array olusturunuz 6 eleman ekleyiniz,"Yellow" dan sonraki elemanlari yazdiriniz.
        ...
        //2.Yol
        //Yellow elemanin indexini bul ve o indexden daha buyuk indexe sahip olan elemanlari yazdir.
        int counter=0;
        for (String w:color) {
            if (w.equals("Yellow")){
                break;
